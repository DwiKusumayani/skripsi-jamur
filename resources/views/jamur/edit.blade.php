            ...
            <div class="row">
                <div class="col-12">
                  <div class="fv-row mb-8 fv-plugins-icon-container">
                    ...
                    <input type="text" class="form-control form-control-solid" name="nama" value="{{ $item->nama }}"
                ...
                <div class="col-12">
                  <div class="fv-row mb-8 fv-plugins-icon-container">
                    ...
                    <input type="date" class="form-control form-control-solid" name="tanggal" value="{{ $item->tanggal_tanam }}" required />
                  </div>
                </div>
              </div>
